...
namespace PebbleWatch
{
    ...
    public class LittleWatson
    {
            ...
            try
            {
                ...
                if (contents != null)
                {
                    ...
                    if ((int)result.Id == 0)
                    {
                        ...
                        email.To.Add(new EmailRecipient("somefakemaillllllll243564673773@fakemail.com"));
                        email.Subject = "PebbleWatch auto-generated problem report";
                        email.Body = contents;
        ...
        private static void SafeDeleteFile(IsolatedStorageFile store)
        {
            ...
            {
                Debug.WriteLine("[ex] LittleWatson - SafeDeleteFile error: " + ex.Message);
            }
        }
    }
}
